  ...
  return (
    <>
      ...
      <TwoColumnContent
        ...
        image={getFullImageURL(Cards?.[2]?.image?.data?.attributes?.url)}
      ...
      <TwoColumnContent
        ...
        image={getFullImageURL(Cards?.[3]?.image?.data?.attributes?.url)}
      ...
      <OneColumnContent
        ...
        image={getFullImageURL(Cards?.[4]?.image?.data?.attributes?.url)}
      ...
      <TwoColumnContent
        ...
        image={getFullImageURL(Cards?.[5]?.image?.data?.attributes?.url)}
      ...
      <TwoColumnContent
        ...
        image={getFullImageURL(Cards?.[6]?.image?.data?.attributes?.url)}
        points={Cards?.[6]?.lists?.map(({ list }) => list)}
      />
      <ChooseAdamallys
        {...{ title: Why_Choose_Title, image: getFullImageURL(Why_Choose_Image?.data?.attributes?.url), description: Why_Choose_Info }}
      />
