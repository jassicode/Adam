    ...
    <main className=''>
      ...
      <div className="mt-[72px]">
        <TwoColumnContent
          link={cards?.[0]?.link}
          title={cards?.[0]?.title}
          image={getFullImageURL(cards?.[0]?.Icon?.data?.attributes?.url)}
      ...
      <TwoColumnContent
        ...
        link={cards?.[1]?.link}
        title={cards?.[1]?.title}
        image={getFullImageURL(cards?.[1]?.Icon?.data?.attributes?.url)}
        caption={cards?.[1]?.info}
      />
      <TwoColumnContent
        link={cards?.[2]?.link}
        title={cards?.[2]?.title}
        image={getFullImageURL(cards?.[2]?.Icon?.data?.attributes?.url)}
      ...
      <TwoColumnContent
        ...
        link={cards?.[3]?.link}
        title={cards?.[3]?.title}
        image={getFullImageURL(cards?.[3]?.Icon?.data?.attributes?.url)}
