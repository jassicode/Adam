  ...
  return (
    <>
      ...
      <LeadingPageBanner
        ...
        bgImage={getFullImageURL(data?.Banner_Image?.data?.attributes?.url)}
      ...
      <div className="my:6 lg:my-[56px] flex flex-col gap-6 lg:gap-10">
        <div className="lg:sticky top-[90px]">
          <TwoColumnContent
            ...
            image={getFullImageURL(data?.Cards?.[0]?.image?.data?.attributes?.url)}
        ...
        <div className="lg:sticky top-[90px]">
          <TwoColumnContent
            ...
            image={getFullImageURL(data?.Cards?.[1]?.image?.data?.attributes?.url)}
        ...
        <div className="lg:sticky top-[90px]">
          <TwoColumnContent
            ...
            image={getFullImageURL(data?.Cards?.[2]?.image?.data?.attributes?.url)}
